...
This is the code I used to compute the results for the CVPR paper 
...
is the application containing the logic to load and preprocess data,
...
#######################################################################################################
# Main Workflow 
#  - to get the results of the paper
...
#######################################################################################################
# TODO 
#   - Things I wanted to get done before releasing the code, 
#     but apparently wont get around to  
